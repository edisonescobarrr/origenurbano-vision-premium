      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="group bg-background p-8 shadow-soft hover:shadow-elevated transition-all duration-500 border border-transparent hover:border-gold/20"
            >
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 bg-primary flex items-center justify-center group-hover:bg-gold transition-colors duration-300">
